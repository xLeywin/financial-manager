...
public class TestConfig implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Income income1 = new Income("Salário", 2900.00, u1);
        Income income2 = new Income("Salário", 4000.00, u2);
        Income income3 = new Income("Bônus", 500.00, u1);
        incomeRepository.saveAll(Arrays.asList(income1, income2, income3));

        Expense expense1 = new Expense("Gasolina", 50.00, u1);
        Expense expense2 = new Expense("Conta de luz", 150.00, u2);
        Expense expense3 = new Expense("Almoço", 35.00, u1);
